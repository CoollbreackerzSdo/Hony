...
/// </summary>
internal sealed class PaginationCategoryHandler(IUnitOfWord word) : IHandler<PaginationEntity, ImmutableList<CategoryView>>
{
    /// <summary>
    ...
    public Result<ImmutableList<CategoryView>> Handle(PaginationEntity command)
